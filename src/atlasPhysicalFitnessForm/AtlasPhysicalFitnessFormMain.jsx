...
// const AtlasPhysicalFitnessFormMain = () => {
//     return (
//         <div>
...
// export default AtlasPhysicalFitnessFormMain
...
import AtlasPhysicalFitnessFormTemplate from "./AtlasPhysicalFitnessFormTemplate";

const AtlasPhysicalFitnessFormMain = ({
    corpId = "c14dd57c-d2a1-492a-8eb3-3c11d2eb7ac5",
    campCycleId = "394961",
    ...
    const generatePDF = async (data, index) => {
        try {
            ...
            const pdfBlob = await pdf(
                <AtlasPhysicalFitnessFormTemplate
                    data={data}
                    fitText={fitText}
    ...
    return (
        <Fragment>
            <h1>AtlasPhysicalFitnessFormMain</h1>
            {/* User Inputs */}
