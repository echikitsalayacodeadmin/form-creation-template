...
const HindalcoMERFormContractor = ({
...
<head>
<meta charset="UTF-8" />
<title>Medical Examination Record</title>
<style>
  body {
...
<div class="form-container">
  ...
  >
    ...
    <div class="form-subtitle">
      PERSONAL MOBILITY - CHAKAN PUNE<br />MEDICAL
  ...
  <table>
    ...
    <tr>
      ...
      <td>${dayjs(data?.vitalsCreatedDate).format("DD-MM-YYYY") || ""}</td>
  ...
  <table>
    ...
    <tr>
      ...
      <td colspan="6">${data?.pemMedicalFormData?.general_remarks || "NIL"}</td>
    </tr>
  </table>
  <table>
    <tr>
  ...
  <table>
    ...
    <tr>
      ...
      <td>[R] ${data?.pemMedicalFormData?.ent_tympanic_right || "Healthy & Intact"
      }</td>
      <td>[L] ${data?.pemMedicalFormData?.ent_tympanic_left || "Healthy & Intact"
      }</td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>${data?.pemMedicalFormData?.ent_tonsils || "Non Palpable"}</td>
    </tr>
    <tr>
  ...
  <table>
    ...
    <tr>
      ...
      <td>S1 + ${data?.pemMedicalFormData?.cardio_heart_sound_s1 || ""}</td>
      <td>S2 + ${data?.pemMedicalFormData?.cardio_heart_sound_s2 || ""}</td>
      <td>
    ...
    <tr>
      ...
      <td colspan="3">${data?.pemMedicalFormData?.cardio_other || "NIL"}</td>
    </tr>
  </table>
  <table>
    <tr>
    ...
    <tr>
      ...
      <td>${data?.pemMedicalFormData?.respiratory_lungs || "B/L AE +"}</td>
    </tr>
    <tr>
      <td class="label">Breath sounds:</td>
      <td colspan="2">
        ${data?.pemMedicalFormData?.respiratory_breath_sounds || "B/L Clear"}
      </td>
    ...
    <tr>
      <td colspan="5" class="label">
        ...
        <span style="font-weight: 400"
          >${data?.pemMedicalFormData?.respiratory_others || "NIL"}</span
        >
      </td>
    </tr>
  </table>
  ...
  <table>
    ...
    <tr>
      ...
      <td>${data?.pemMedicalFormData?.cns_reflex_deep || "Within Normal Limits"
      }</td>
    </tr>
    <tr>
      ...
      <td>${data?.pemMedicalFormData?.cns_sensory || "Well Functional"}</td>
    ...
    <tr>
      ...
      <td>${data?.pemMedicalFormData?.cns_posture || "Healthy dynamics"}</td>
      <td colspan="6" class="label">
        Remarks:
        <span style="font-weight: 400"
  ...
  <table>
    ...
    <tr>
      ...
      <td colspan="3">${data?.pemMedicalFormData?.skeletal_spine || "No external deformity seen"
      }</td>
    </tr>
    <tr>
      <td class="label">Any Other:</td>
      <td colspan="7">${data?.pemMedicalFormData?.skeletal_other || "NIL"}</td>
    </tr>
  </table>
  <table>
    <tr>
  ...
  <table>
    ...
    formData.append("file", pdfBlob, `${data.empId}_Contractor_MER_Form.pdf`);
    ...
    if (result && result.data) {
      ...
      const temp = result?.data.filter(
        (item) =>
          ...
          (item.vitalsCreatedDate === "2025-07-23" ||
            item.vitalsCreatedDate === "2025-07-24" ||
            item.vitalsCreatedDate === "2025-07-25" ||
            item.vitalsCreatedDate === "2025-07-26")
        //  &&
...
export default HindalcoMERFormContractor;
