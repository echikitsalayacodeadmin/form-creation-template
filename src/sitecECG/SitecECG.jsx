...
function whiteOutSeal(page, baseX, baseY) {
    page.drawRectangle({
        x: baseX + 240,   // move right from "Interpretations :"
        y: baseY - 75,     // slight downward adjustment
        width: 250,       // covers signature + stamp
        height: 70,
        color: rgb(1, 1, 1),
        opacity: 1,
    });
