...
import ZestPharmaMERFormTemplate from "./ZestPharmaMERFormTemplate";

const ZestPharmaMERFormMain = ({
    ...
    const generatePDF = async (data, index) => {
        ...
        try {
            const pdfBlob = await pdf(
                <ZestPharmaMERFormTemplate data={data} />
            ).toBlob();
        ...
        if (corpId && campCycleId) {
            ...
            if (result && result.data) {
                ...
                const temp = result?.data?.filter((item) => [
                    "10201", "10105", "ZP92", "10177", "ZP103", "10128", "10231", "10162", "10185", "10144", "10323", "10177", "10231"
                ].includes(item.empId));
    ...
    return (
        <Fragment>
            ...
            <PDFViewer style={{ width: "100%", height: "calc(100vh - 64px)" }}>
                <ZestPharmaMERFormTemplate data={list[0]} />
            </PDFViewer>
        </Fragment>
    );
};

export default ZestPharmaMERFormMain;
