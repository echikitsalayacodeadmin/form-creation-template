...
const MaharashtraFactRule = ({
  ...
  const tableHeaders = [
    { id: 1, label: "Serial No.", value: data?.empId || "" },
    { id: 2, label: "Works No.", value: "" },
    { id: 3, label: "Name of worker", value: data?.name || "" },
    { id: 4, label: "Sex", value: data?.gender || "" },
    { id: 5, label: "Age (last birthday)", value: data?.age || "" },
    { id: 6, label: "Date of employment of present work", value: "" },
    { id: 7, label: "Date of leaving or transfer to other work", value: "" },
    { id: 8, label: "Reason for leaving Transfer or discharge", value: "" },
    { id: 9, label: "Nature of job or occupation", value: "" },
    { id: 10, label: "Raw material or bye-product handled", value: "" },
    {
      id: 11,
      label: "Date of medical Examination by Certifying Surgeon",
      value: data?.vitalsCreatedDate || vitalsCreatedDate || "",
    },
    { id: 12, label: "Results of Medical Examination", value: "FIT" },
    {
      id: 13,
      label:
      ...
      <Document>
        <Page size="A4" style={styles.page}>
          ...
          <Text style={styles.rule}>
            (See rule 18(7) and Schedules II, III, IV, VI, VIII, X, XI, XIII,
            XIV, XV, XVII, XVIII and XX to Rule 114)
          </Text>
          ...
          <View style={styles.bottomSection} fixed>
            ...
            <View style={styles.noteRow}>
              ...
              <Text style={styles.noteText}>
                (i) Col. 8 - Detailed summery of reason for transfer or
