...
import headerBackend from "../assets/images/headerBackend.png";
...
async function mergeHeaderWithReport(reportPdfBytes) {
  ...
  // Import header image
  const headerImageBytes = await fetch(headerBackend).then((res) =>
    res.arrayBuffer()
  );
...
export default HeaderFormsForPuneCorps;
