...
const RahejaFassi = ({
    corpId = "d8774712-e4b8-4e3c-bbf6-a31b12f46fdb",
    campCycleId = "433833",
    fileType = "FITNESS_CERTIFICATE_FOOD",
    corpName = "Raheja Solar Food Processing Pvt Ltd",
    year = "2026",
}) => {
    ...
    const generatePDF = async (data, index) => {
        const employeeName = (data?.name || "").toLowerCase();
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
      ...
      <body>
        ...
        <div style="padding-left: 5%; padding-right: 5%; padding-top: 3%">
          <br />
          <p style="padding-top: 4pt; padding-left: 2pt; text-indent: 0pt; text-align: left;">
            <br />
          </p>
          <p
            style="
          ...
          >
            Shri/Smt
            <span style="text-transform: capitalize; text-decoration: underline">${employeeName}</span>
            employed with <b>M/S ${corpName}</b> 
            coming in direct contact with food
            items has been carefully examined* by me on date
            <u>&nbsp;&nbsp;&nbsp;${examDate}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>
    ...
    const fetchListOfEmployees = async () => {
        ...
        if (result && result.data) {
            ...
            const empIDS = ["R1", "R2", "R3", "R4", "R5", "R6", "R7", "R8", "R9", "R10", "R11", "R12", "R13", "R14", "R15", "R16", "R17", "R18", "R19", "R20"] || [];
