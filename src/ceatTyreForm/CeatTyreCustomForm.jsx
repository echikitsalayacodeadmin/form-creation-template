...
// import CeatTyreCustomFormTemplate from "./CeatTyreCustomFormTemplate";

//   const CeatTyreCustomForm = ({
//     corpId = "ed07ff36-2150-4093-aa44-c91b08fa206d",
//     campCycleId = "372462",
//     fileType = "ANNEXURE",
//   }) => {
//     const _storedData = (() => {
...
//   <CeatTyreCustomFormTemplate data={data} />
// ).toBlob();
...
//          <CeatTyreCustomFormTemplate data={filteredList[0]} />
//         </PDFViewer>
//       </Fragment>
//     );
//   };

//   export default CeatTyreCustomForm;
...
const CeatTyreCustomForm = () => {
  const data = {
    ...
    pulseRate: '82',
    skin: "Normal",
    vision: 'Advised to continue using same glasses',
    colorVision: 'Normal',


    hb: "14.4 g/dl",
    wbc: "6470 cells/cu.mm",
    rbc: "4.98 mil/cmm",
    platelet: "2.81 lakhs/cu.mm",
    glucose: "131.0 mg/dl",
    creatinine: "0.94 mg/dL",

    personalHistory: "Nil Significant",
    familyHistory: "Diabetes mellitus-Father",
    presentComplaints: "Nil Significant",
    ...
    bmiAdvice:
      "BMI of 25–30 indicates overweight. Weight reduction through diet and exercise is recommended.",
  };
