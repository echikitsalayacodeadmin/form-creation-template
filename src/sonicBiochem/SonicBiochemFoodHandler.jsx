...
const SonicBiochemFoodHandler = ({
  corpId = "1074856a-f014-4821-839b-1d12ee96c642",
  campCycleId = "296586",
  fileType = "FITNESS_CERTIFICATE_FOOD",
  corpName = "Sonic Biochem Extraction Pvt Ltd",
  campDate = "3rd July, 2025",
  year = "2025",
}) => {
...
export default SonicBiochemFoodHandler;
