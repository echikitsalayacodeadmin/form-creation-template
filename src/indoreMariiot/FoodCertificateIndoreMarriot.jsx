...
const FoodCertificateIndoreMarriot = ({
  corpId = "86d78fb6-1060-447e-83d3-5822aab22e66", ///acg
  campCycleId = "351099",
  fileType = "FITNESS_CERTIFICATE_FOOD",
  corpName = "Indore Marriott Hotel",
}) => {
...
export default FoodCertificateIndoreMarriot;
