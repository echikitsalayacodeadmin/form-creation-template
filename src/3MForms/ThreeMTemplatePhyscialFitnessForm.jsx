...
const ThreeMTemplatePhyscialFitnessForm = ({
    data,
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <Text style={[styles.cell, { width: "25%" }, styles.cellNoRight]}>
                            ...
                            {data?.cholestrolData?.["BLOOD SUGAR RANDOM"] ? `${data?.cholestrolData?.["BLOOD SUGAR RANDOM"]} mg/dL` : ""}
                        </Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <Text style={[styles.cell, { width: "16.6%" }]}>Self</Text>
                        <Text style={[styles.cell, { width: "16.6%" },]}>
                            Family
                        </Text>
                        <Text style={[styles.cell, { width: "16.6%" }, styles.cellNoRight]}>
                            Occupational
                        </Text>
                        <Text
                            style={[styles.cell, { width: 0 }, styles.cellNoRight]}
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <Text style={[styles.cell, { width: "16.6%" }]}>NA</Text>
                        <Text style={[styles.cell, { width: "16.6%" },]}>
                            NA
                        </Text>
                        <Text style={[styles.cell, { width: "16.6%" }, styles.cellNoRight]}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        >
                            As per above physical examination of skin & eye, we can conclude that the person is free from skin & eye infection and contagious diseases.
                        </Text>
                        <Text
                            style={[styles.cell, { width: 0 }, styles.cellNoRight]}
                        ></Text>
...
export default ThreeMTemplatePhyscialFitnessForm;
