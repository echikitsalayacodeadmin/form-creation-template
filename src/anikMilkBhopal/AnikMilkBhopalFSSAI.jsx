...
const AnikMilkBhopalFSSAI = ({
  corpId = "faa799a1-7565-4e43-9a72-699dd6c1359b",
  campCycleId = "340655",
  fileType = "FITNESS_CERTIFICATE_FOOD",
  corpName = "Anik Milk Bhopal",
            ...
            contact with food items has been carefully examined* by me on date <u
              >&nbsp;&nbsp;&nbsp;${
                data?.vitalsCreatedDate
                  ? dayjs(data?.vitalsCreatedDate).format("DD MMM, YYYY")
                  : ""
              }&nbsp;
            </u> Based
...
export default AnikMilkBhopalFSSAI;
