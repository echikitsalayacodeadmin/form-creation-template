            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={[styles.cell, { width: "20%" }, styles.label]}>PLAN</Text>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={[styles.cell, { width: "25%" }, styles.label]}>FT/CM</Text>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={[styles.cell, { width: "80%", borderRight: 0 }]}>
                            SKIN AND OTHER COMMUNICABLE DISEASES NOT OBSERVED
                        </Text>
                    </View>
                ...
                <View style={{ marginTop: 10, flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                    ...
                    <View>
                        ...
                        <Image src={prashantDeshmukh} style={{ height: 100, width: 130, marginTop: 10 }} />
                    </View>
                </View>
            </Page>
        </Document>
